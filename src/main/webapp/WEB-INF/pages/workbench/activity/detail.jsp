			...
			$.ajax({
				...
				success:function (data) {
					if(data.state=="SUCCESS"){
						...
						htmlStr+="<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${activity.name}</b> <small style=\"color: gray;\"> "+data.data.createTime+" 由${sessionScope.USER.name}创建</small>";
