			...
			$.ajax({
				...
				success:function (data) {
					if(data.state=="SUCCESS"){
						...
						htmlStr+="<font color=\"gray\">线索</font> <font color=\"gray\">-</font> <b>${clue.fullname}${clue.appellation}</b> <font color=\"gray\">-</font> <b>${clue.company}</b> <small style=\"color: gray;\"> "+data.data.createTime+" 由${sessionScope.USER.name}创建</small>";
			...
			$.ajax({
				...
				success:function (data) {
					if(data.state=="SUCCESS"){
						...
						$("#div_"+data.data.id+" small").text(" "+data.data.editTime+" 由${sessionScope.USER.name}修改");
					}else{
						//提示信息
						alert(data.message);
						//模态窗口不关闭
